...
class ManagerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Manager
        fields = ('id','firstname', 'lastname', 'dob', 'gender', 'emailid', 'mobileno', 'address', 'state', 'city', 'photograph','password')
...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = ('id','firstname', 'lastname', 'dob', 'gender', 'emailid', 'mobileno1','organization','mobileno2','address', 'state', 'city', 'photograph')
...
class AdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Administrator
        fields = ('id','mobileno','emailid ','adminname','password','Profilepic')        
